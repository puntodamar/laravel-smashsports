                    ...
                    <div class="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
                        <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                            <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                                <h1 class="font-heading text-5xl font-semibold tracking-tight text-pretty text-black dark:text-gold sm:text-7xl"><i>Your One Stop Badminton Center!</i></h1>
                                <p class="mt-8 text-lg font-medium font-body text-pretty text-black dark:text-gray sm:max-w-md sm:text-xl/8 lg:max-w-none">Nikmati rasanya badminton di lapangan standar BWF, toko olahraga yang lengkap, dan resto yang enak!</p>
                                <div class="mt-10 flex items-center gap-x-6">
                                    <a href="#"
                                       class="rounded-md btn-accent px-3.5 py-2.5 text-sm font-semibold shadow-xs text-white  hover:text-black hover:bg-gold focus-visible:outline-2 focus-visible:outline-offset-2  focus-visible:bg-gold dark:hover:bg-gold dark:text-gray focus-visible:text-black">
                                    ...
                                    <a href="#" class="text-sm/6 font-semibold text-black dark:text-gray dark:hover:text-gold">Toko <span aria-hidden="true">→</span></a>
                                </div>
                            </div>
